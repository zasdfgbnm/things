...
def nvfuser_fusion_id1(fd : FusionDefinition) -> None :
    ...
    S19 = fd.define_scalar(0.00000, dtype=DataType.Double)
    S20 = fd.define_scalar(1.00000, dtype=DataType.Double)
    ...
    S26 = fd.define_scalar(0.900000, dtype=DataType.Double)
